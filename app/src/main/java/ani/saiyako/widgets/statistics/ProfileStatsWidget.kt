package ani.saiyako.widgets.statistics
...
import ani.saiyako.util.BitmapUtil.downloadImageAsBitmap
import ani.saiyako.widgets.WidgetSizeProvider
...
class ProfileStatsWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun getPrefsName(appWidgetId: Int): String {
            return "ani.saiyako.widgets.Statistics.${appWidgetId}"
        }
