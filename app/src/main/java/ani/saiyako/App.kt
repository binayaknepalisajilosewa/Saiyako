...
import ani.saiyako.aniyomi.anime.custom.AppModule
import ani.saiyako.aniyomi.anime.custom.PreferenceModule
import ani.saiyako.connections.comments.CommentsAPI
import ani.saiyako.connections.crashlytics.CrashlyticsInterface
import ani.saiyako.notifications.TaskScheduler
import ani.saiyako.others.DisabledReports
import ani.saiyako.parsers.AnimeSources
import ani.saiyako.parsers.MangaSources
import ani.saiyako.parsers.NovelSources
import ani.saiyako.parsers.novel.NovelExtensionManager
import ani.saiyako.settings.SettingsActivity
import ani.saiyako.settings.saving.PrefManager
import ani.saiyako.settings.saving.PrefName
import ani.saiyako.util.FinalExceptionHandler
...
class App : MultiDexApplication() {
    ...
    override fun onCreate() {
        ...
        val crashlytics =
            ani.saiyako.connections.crashlytics.CrashlyticsFactory.createCrashlytics()
