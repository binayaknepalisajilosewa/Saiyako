...
import ani.saiyako.addons.AddonDownloader.Companion.hasUpdate
import ani.saiyako.addons.AddonListener
import ani.saiyako.addons.AddonLoader
import ani.saiyako.addons.AddonManager
import ani.saiyako.addons.LoadResult
import ani.saiyako.addons.AddonInstallReceiver
...
class TorrentAddonManager(
    ...
    companion object {
        ...
        const val TORRENT_CLASS = "ani.saiyako.torrentAddon.TorrentAddon"
        const val REPO = "rebelonion/Saiyako-Torrent-Addon"
    }
}