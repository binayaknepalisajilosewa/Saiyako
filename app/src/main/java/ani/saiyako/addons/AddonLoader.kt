...
import ani.saiyako.addons.download.DownloadAddon
import ani.saiyako.addons.download.DownloadAddonApiV2
import ani.saiyako.addons.download.DownloadAddonManager
import ani.saiyako.addons.download.DownloadLoadResult
import ani.saiyako.addons.torrent.TorrentAddon
import ani.saiyako.addons.torrent.TorrentAddonApi
import ani.saiyako.addons.torrent.TorrentAddonManager
import ani.saiyako.addons.torrent.TorrentLoadResult
import ani.saiyako.media.AddonType
...
class AddonLoader {
    companion object {
        ...
        fun loadExtension(
            ...
            val extName =
                pkgManager.getApplicationLabel(appInfo).toString().substringAfter("Saiyako: ")
