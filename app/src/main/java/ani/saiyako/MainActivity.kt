...
import ani.saiyako.connections.anilist.AnilistHomeViewModel
import ani.saiyako.databinding.ActivityMainBinding
import ani.saiyako.databinding.DialogUserAgentBinding
import ani.saiyako.databinding.SplashScreenBinding
import ani.saiyako.home.AnimeFragment
import ani.saiyako.home.HomeFragment
import ani.saiyako.home.LoginFragment
import ani.saiyako.home.MangaFragment
import ani.saiyako.home.NoInternet
...
import ani.saiyako.others.calc.CalcActivity
import ani.saiyako.profile.ProfileActivity
import ani.saiyako.profile.activity.FeedActivity
import ani.saiyako.profile.activity.NotificationActivity
import ani.saiyako.settings.ExtensionsActivity
import ani.saiyako.settings.saving.PrefManager
import ani.saiyako.settings.saving.PrefManager.asLiveBool
import ani.saiyako.settings.saving.PrefName
import ani.saiyako.settings.saving.SharedPreferenceBooleanLiveData
import ani.saiyako.settings.saving.internal.PreferenceKeystore
import ani.saiyako.settings.saving.internal.PreferencePackager
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    if (!(PrefManager.getVal(PrefName.AllowOpeningLinks) as Boolean)) {
                        CustomBottomDialog.newInstance().apply {
                            title = "Allow Saiyako to automatically open Anilist & MAL Links?"
