...
import ani.saiyako.connections.anilist.getUserId
import ani.saiyako.currContext
import ani.saiyako.databinding.FragmentHomeBinding
import ani.saiyako.home.status.UserStatusAdapter
...
import ani.saiyako.media.user.ListActivity
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        {
            binding.homeSaiyakoContainer.visibility = if (it == true) View.VISIBLE else View.GONE
            (binding.homeSaiyakoIcon.drawable as Animatable).start()
            binding.homeSaiyakoContainer.startAnimation(setSlideUp())
            binding.homeSaiyakoIcon.setSafeOnClickListener {
                (binding.homeSaiyakoIcon.drawable as Animatable).start()
            }
        }
