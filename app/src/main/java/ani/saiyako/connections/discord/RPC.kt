package ani.saiyako.connections.discord

import ani.saiyako.connections.discord.serializers.Activity
import ani.saiyako.connections.discord.serializers.Presence
...
import ani.saiyako.client as app
                    ...
                    activities = listOf(
                        Activity(
                            ...
                            assets = Activity.Assets(
                                ...
                                smallText = if (PrefManager.getVal(PrefName.ShowAniListIcon)) "Anilist" else "Saiyako",
                            ),
