package ani.saiyako.connections.anilist.api
...
class Query {
    ...
    data class Viewer(
        ...
        data class Data(
            @SerialName("Viewer")
            val user: ani.saiyako.connections.anilist.api.User?
        )
    }
    ...
    data class Media(
        ...
        data class Data(
            @SerialName("Media")
            val media: ani.saiyako.connections.anilist.api.Media?,
            @SerialName("Page")
            val page: ani.saiyako.connections.anilist.api.Page?
        )
    }
...
//    ){
//        data class Data(
//            val AiringSchedule: ani.saiyako.connections.anilist.api.AiringSchedule?
//        )
//    }
    ...
    data class Character(
        ...
        data class Data(
            ...
            val character: ani.saiyako.connections.anilist.api.Character?
        )
    }
    ...
    data class Studio(
        ...
        data class Data(
            @SerialName("Studio")
            val studio: ani.saiyako.connections.anilist.api.Studio?
        )
    }
...
//    ){
//        data class Data(
//            val MediaList: ani.saiyako.connections.anilist.api.MediaList?
//        )
//    }
    ...
    data class MediaListCollection(
        ...
        data class Data(
            ...
            val mediaListCollection: ani.saiyako.connections.anilist.api.MediaListCollection?
        )
    }
    ...
    data class CombinedMediaListResponse(
        ...
        @Serializable
        data class Data(
            @SerialName("current") val current: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("planned") val planned: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("repeating") val repeating: ani.saiyako.connections.anilist.api.MediaListCollection?,
        )
    }
    ...
    data class HomePageMedia(
        ...
        @Serializable
        data class Data(
            @SerialName("currentAnime") val currentAnime: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingAnime") val repeatingAnime: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteAnime") val favoriteAnime: ani.saiyako.connections.anilist.api.User?,
            @SerialName("plannedAnime") val plannedAnime: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("currentManga") val currentManga: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("repeatingManga") val repeatingManga: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("favoriteManga") val favoriteManga: ani.saiyako.connections.anilist.api.User?,
            @SerialName("plannedManga") val plannedManga: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationQuery") val recommendationQuery: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("recommendationPlannedQueryAnime") val recommendationPlannedQueryAnime: ani.saiyako.connections.anilist.api.MediaListCollection?,
            @SerialName("recommendationPlannedQueryManga") val recommendationPlannedQueryManga: ani.saiyako.connections.anilist.api.MediaListCollection?,
    ...
    data class AnimeList(
        ...
        @Serializable
        data class Data(
            @SerialName("recentUpdates") val recentUpdates: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("recentUpdates2") val recentUpdates2: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("trendingMovies") val trendingMovies: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("trendingMovies2") val trendingMovies2: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("topRated2") val topRated2: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("mostFav2") val mostFav2: ani.saiyako.connections.anilist.api.Page?,
        )
    }
    ...
    data class MangaList(
        ...
        @Serializable
        data class Data(
            @SerialName("trendingManga") val trendingManga: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("trendingManga2") val trendingManga2: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("trendingManhwa") val trendingManhwa: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("trendingManhwa2") val trendingManhwa2: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("trendingNovel") val trendingNovel: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("trendingNovel2") val trendingNovel2: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("topRated") val topRated: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("topRated2") val topRated2: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("mostFav") val mostFav: ani.saiyako.connections.anilist.api.Page?,
            @SerialName("mostFav2") val mostFav2: ani.saiyako.connections.anilist.api.Page?,
    ...
    data class FollowerPage(
        ...
        val followers: List<ani.saiyako.connections.anilist.api.User>?
    ) : java.io.Serializable

    @Serializable
    data class FollowingPage(
        @SerialName("following")
        val following: List<ani.saiyako.connections.anilist.api.User>?
    ) : java.io.Serializable
