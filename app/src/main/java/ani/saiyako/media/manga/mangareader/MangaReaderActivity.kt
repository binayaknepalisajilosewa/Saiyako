package ani.saiyako.media.manga.mangareader
...
import ani.saiyako.GesturesListener
import ani.saiyako.NoPaddingArrayAdapter
import ani.saiyako.R
import ani.saiyako.connections.anilist.Anilist
import ani.saiyako.connections.crashlytics.CrashlyticsInterface
import ani.saiyako.connections.discord.Discord
import ani.saiyako.connections.discord.DiscordService
import ani.saiyako.connections.discord.DiscordServiceRunningSingleton
import ani.saiyako.connections.discord.RPC
import ani.saiyako.connections.updateProgress
import ani.saiyako.currContext
import ani.saiyako.databinding.ActivityMangaReaderBinding
import ani.saiyako.dp
import ani.saiyako.hideSystemBarsExtendView
...
import ani.saiyako.media.MediaSingleton
import ani.saiyako.media.manga.MangaCache
import ani.saiyako.media.manga.MangaChapter
import ani.saiyako.others.ImageViewDialog
import ani.saiyako.parsers.HMangaSources
import ani.saiyako.parsers.MangaImage
import ani.saiyako.parsers.MangaSources
import ani.saiyako.px
import ani.saiyako.setSafeOnClickListener
import ani.saiyako.settings.CurrentReaderSettings
import ani.saiyako.settings.CurrentReaderSettings.Companion.applyWebtoon
import ani.saiyako.settings.CurrentReaderSettings.Directions.BOTTOM_TO_TOP
import ani.saiyako.settings.CurrentReaderSettings.Directions.LEFT_TO_RIGHT
import ani.saiyako.settings.CurrentReaderSettings.Directions.RIGHT_TO_LEFT
import ani.saiyako.settings.CurrentReaderSettings.Directions.TOP_TO_BOTTOM
import ani.saiyako.settings.CurrentReaderSettings.DualPageModes.Automatic
import ani.saiyako.settings.CurrentReaderSettings.DualPageModes.Force
import ani.saiyako.settings.CurrentReaderSettings.DualPageModes.No
import ani.saiyako.settings.CurrentReaderSettings.Layouts.CONTINUOUS_PAGED
import ani.saiyako.settings.CurrentReaderSettings.Layouts.PAGED
import ani.saiyako.settings.saving.PrefManager
import ani.saiyako.settings.saving.PrefName
import ani.saiyako.showSystemBarsRetractView
                    ...
                    lifecycleScope.launch {
                        ...
                        val buttons = when (discordMode) {
                            ...
                            "dantotsu" -> mutableListOf(
                                RPC.Link(getString(R.string.view_manga), media.shareLink ?: ""),
                                RPC.Link("Read on Saiyako", getString(R.string.saiyako))
                            )
