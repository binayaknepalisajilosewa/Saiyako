...
import ani.saiyako.databinding.FragmentAnimeWatchBinding
import ani.saiyako.download.DownloadedType
import ani.saiyako.download.DownloadsManager
import ani.saiyako.download.DownloadsManager.Companion.compareName
import ani.saiyako.download.manga.MangaDownloaderService
import ani.saiyako.download.manga.MangaServiceDataSingleton
import ani.saiyako.dp
import ani.saiyako.isOnline
import ani.saiyako.media.Media
import ani.saiyako.media.MediaDetailsActivity
...
import ani.saiyako.media.manga.mangareader.ChapterLoaderDialog
import ani.saiyako.navBarHeight
import ani.saiyako.notifications.subscription.SubscriptionHelper
import ani.saiyako.notifications.subscription.SubscriptionHelper.Companion.saveSubscription
import ani.saiyako.others.LanguageMapper
import ani.saiyako.parsers.DynamicMangaParser
import ani.saiyako.parsers.HMangaSources
import ani.saiyako.parsers.MangaParser
import ani.saiyako.parsers.MangaSources
import ani.saiyako.setNavigationTheme
import ani.saiyako.settings.extensionprefs.MangaSourcePreferencesFragment
import ani.saiyako.settings.saving.PrefManager
import ani.saiyako.settings.saving.PrefName
import ani.saiyako.snackString
import ani.saiyako.util.StoragePermissions.Companion.accessAlertDialog
import ani.saiyako.util.StoragePermissions.Companion.hasDirAccess
