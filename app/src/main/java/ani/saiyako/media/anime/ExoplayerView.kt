...
import ani.saiyako.brightnessConverter
import ani.saiyako.circularReveal
...
import ani.saiyako.databinding.ActivityExoplayerBinding
import ani.saiyako.defaultHeaders
import ani.saiyako.download.DownloadsManager.Companion.getSubDirectory
import ani.saiyako.download.video.Helper
import ani.saiyako.dp
import ani.saiyako.getCurrentBrightnessValue
import ani.saiyako.hideSystemBars
...
import ani.saiyako.media.MediaType
import ani.saiyako.media.SubtitleDownloader
import ani.saiyako.okHttpClient
import ani.saiyako.others.AniSkip
import ani.saiyako.others.AniSkip.getType
import ani.saiyako.others.LanguageMapper
import ani.saiyako.others.ResettableTimer
import ani.saiyako.others.getSerialized
import ani.saiyako.parsers.AnimeSources
import ani.saiyako.parsers.HAnimeSources
import ani.saiyako.parsers.Subtitle
import ani.saiyako.parsers.SubtitleType
import ani.saiyako.parsers.Video
import ani.saiyako.parsers.VideoExtractor
import ani.saiyako.parsers.VideoType
import ani.saiyako.settings.PlayerSettingsActivity
                    ...
                    lifecycleScope.launch {
                        ...
                        val buttons = when (discordMode) {
                            ...
                            "dantotsu" -> mutableListOf(
                                RPC.Link(getString(R.string.view_anime), media.shareLink ?: ""),
                                RPC.Link("Watch on Saiyako", getString(R.string.saiyako))
                            )
                        ...
                        val presence = RPC.createPresence(
                            RPC.Companion.RPCData(
                                ...
                                smallImage = RPC.Link("Saiyako", Discord.small_Image),
                                buttons = buttons
                            )
                        )
