...
class ThemeManager(private val context: Activity) {
    fun applyTheme(fromImage: Bitmap? = null) {
        ...
        val themeToApply = when (theme) {
            "BLUE" -> if (useOLED) R.style.Theme_Saiyako_BlueOLED else R.style.Theme_Saiyako_Blue
            "GREEN" -> if (useOLED) R.style.Theme_Saiyako_GreenOLED else R.style.Theme_Saiyako_Green
            "PURPLE" -> if (useOLED) R.style.Theme_Saiyako_PurpleOLED else R.style.Theme_Saiyako_Purple
            "PINK" -> if (useOLED) R.style.Theme_Saiyako_PinkOLED else R.style.Theme_Saiyako_Pink
            "ORIAX" -> if (useOLED) R.style.Theme_Saiyako_OriaxOLED else R.style.Theme_Saiyako_Oriax
            "SAIKOU" -> if (useOLED) R.style.Theme_Saiyako_SaikouOLED else R.style.Theme_Saiyako_Saikou
            "RED" -> if (useOLED) R.style.Theme_Saiyako_RedOLED else R.style.Theme_Saiyako_Red
            "LAVENDER" -> if (useOLED) R.style.Theme_Saiyako_LavenderOLED else R.style.Theme_Saiyako_Lavender
            "OCEAN" -> if (useOLED) R.style.Theme_Saiyako_OceanOLED else R.style.Theme_Saiyako_Ocean
            "MONOCHROME (BETA)" -> if (useOLED) R.style.Theme_Saiyako_MonochromeOLED else R.style.Theme_Saiyako_Monochrome
            else -> if (useOLED) R.style.Theme_Saiyako_PurpleOLED else R.style.Theme_Saiyako_Purple
        }
